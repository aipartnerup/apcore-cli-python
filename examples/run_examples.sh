...
echo "   \$ apcore-cli apcli list --format json"
python -m apcore_cli apcli list --format json
echo ""

echo "2. Filter by tag:"
echo "   \$ apcore-cli apcli list --tag math --format json"
python -m apcore_cli apcli list --tag math --format json
echo ""

echo "3. Describe a module:"
echo "   \$ apcore-cli apcli describe math.add --format json"
python -m apcore_cli apcli describe math.add --format json
echo ""
...
echo "   \$ apcore-cli apcli completion bash | head -5"
python -m apcore_cli apcli completion bash | head -5
echo "   ..."
echo ""
